...
`npm install starwars-quotes`


```javascript
const starwars = require('starwars-quotes');
...
Typing ` starwars-quotes --extended` into your console. A random quote will be displayed with the associated character name and movie title.

You can also type ` starwars-quotes --all` into your console to display all of the available quotes.

And type ` starwars-quotes --all-extended` into your console to display all quotes, each with their associated character name and movie title.
